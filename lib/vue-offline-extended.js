...
/* harmony export */   "VueOfflineMixin": () => (/* binding */ VueOfflineMixin),
/* harmony export */   "VueOfflineStorage": () => (/* binding */ VueOfflineStorage),
/* harmony export */   "VueOfflinePlugin": () => (/* binding */ VueOfflinePlugin),
...
/* harmony import */ var localforage_getitems__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! localforage-getitems */ "./node_modules/localforage-getitems/dist/localforage-getitems.js");
/* harmony import */ var localforage_getitems__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(localforage_getitems__WEBPACK_IMPORTED_MODULE_1__);
...
(0,localforage_getitems__WEBPACK_IMPORTED_MODULE_1__.extendPrototype)((localforage__WEBPACK_IMPORTED_MODULE_0___default()));
/* ----------------------- Mixin ------------------------ */
...
var VueOfflineMixin = {
  ...
  watch: {
    isOffline: function isOffline(status) {
      var _this2 = this;

      if (!status) {
        this.showOnline = true;
        setTimeout(function () {
          return _this2.showOnline = false;
        }, 3000);
      }
    }
  }
...
var VueOfflineStorage = {
  init: function init() {
    ...
    var localforageInstances = localforage__WEBPACK_IMPORTED_MODULE_0___default().createInstance(options);

    if (!options.instances) {
      return localforageInstances;
    }

    var _iterator = _createForOfIteratorHelper(options.instances),
        _step;

    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var instance = _step.value;
        var name = instance.storeName || instance.name;

        if (!name) {
          continue;
        }

        localforageInstances[name] = localforage__WEBPACK_IMPORTED_MODULE_0___default().createInstance(instance);
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
...
var VueOfflinePlugin = {
  install: function install(Vue) {
    ...
    var pluginOptions = _objectSpread(_objectSpread({}, defaultOptions), options);

    if (pluginOptions.storage) Vue.$offlineStorage = Vue.prototype.$offlineStorage = VueOfflineStorage.init(options.storage);

    Vue.prototype.$offlineStorage.createInstance = function (instance) {
      var name = instance.storeName || instance.name;
      Vue.prototype.$offlineStorage[name] = localforage__WEBPACK_IMPORTED_MODULE_0___default().createInstance(instance);
    };

    if (pluginOptions.mixin) Vue.mixin(VueOfflineMixin);
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (VueOfflinePlugin);
})();
...
//# sourceMappingURL=vue-offline-extended.js.map